...
def seed_services(employee_manager, leave_manager, meeting_manager, ticket_manager):
    ...
    employees_data = [
        # Leadership / top managers (use these IDs when creating new employees)
        {
            "emp_id": "E001",
            "name": "Sarah Johnson",
            "manager_id": None,
        ...
        },
        {
            ...
            "manager_id": "E003",
            "email": "james.rodriguez@atliq.com",
            "role": "Software Engineer",
            "department": "Engineering",
        },
        {
